...
def upgrade() -> None:
    ...
    Add route_variants JSON column to lines table to store ordered route sequences
...
def downgrade() -> None:
    ...
    Remove route_variants column from lines table.
    """
    op.drop_column("lines", "route_variants")
