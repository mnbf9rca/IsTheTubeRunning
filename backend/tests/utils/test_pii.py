...
def test_hash_pii_length() -> None:
    """Test that hash_pii returns exactly 12 characters."""
    email = "user@example.com"
    phone = "+447700900123"

    assert len(hash_pii(email)) == 12
    assert len(hash_pii(phone)) == 12
...
def test_hash_pii_examples_from_docstring() -> None:
    ...
    assert hash_pii("user@example.com") == "b4c9a289323b"
    assert hash_pii("+447700900123") == "a8acc3a90a7b"
