...
const calculate_remaining_time = (expected_ttl: number) => {
  const t = new Date()
...
describe('TfL tests', () => {
  describe('TfL calls to get line stoppoints', () => {
    describe('calls without caching', () => {
      test.skip('calls TFL API to get ordered Victoria line stoppoints', async () => {
        const actual_response = await TfL.get_line_stoppoints_in_order('victoria')
    ...
    describe.skip('calls with caching', () => {
  ...
  describe.skip('TfL calls to get disruption', () => {
    describe('calls without caching', () => {
  ...
  describe.skip('TfL calls to get lines for a mode', () => {
    describe('calls without caching', () => {
  ...
  describe('test helper functions', () => {
    ...
    describe('structure_cached_value', () => {
      ...
      test('structure cached value > 0', () => {
        ...
        const actual = TfL_api_mod.structure_cached_value(data, ttl)
