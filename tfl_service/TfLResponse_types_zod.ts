...
import { z } from "zod";
import { TfLResponsePlace } from "./TfLResponse_types";
...
export const tfLResponseLineGroupSchema = z.object({
  naptanIdReference: z.string().optional(),
  stationAtcoCode: z.string().optional(),
  lineIdentifier: z.array(z.string()).optional(),
});

export const tfLResponseLineModeGroupSchema = z.object({
  modeName: z.string(),
  lineIdentifier: z.array(z.string()),
});

export const tfLResponseAdditionalPropertiesSchema = z.object({
...
export const tfLResponsePlaceSchema: z.ZodSchema<TfLResponsePlace> = z.lazy(
  () =>
    z.object({
      id: z.string(),
      ...
      additionalProperties: z
        .array(tfLResponseAdditionalPropertiesSchema)
        .optional(),
      children: z.array(tfLResponsePlaceSchema).optional(),
...
export const tfLResponseStopPointSchema = z.object({
  ...
  lines: z.array(tfLResponseIdentifierSchema),
  lineGroup: z.array(tfLResponseLineGroupSchema),
  lineModeGroups: z.array(tfLResponseLineModeGroupSchema),
  fullName: z.string().optional(),
